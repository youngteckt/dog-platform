...
const PuppyCard = ({ puppy }) => {
  ...
  return (
    <Link to={`/dog/${puppy._id}`} className="block bg-white rounded-xl overflow-hidden border border-gray-200 transition-all duration-300 md:hover:shadow-[0_0_20px_5px_rgba(203,255,0,0.8)]">
      <img 
