...
const FilterModal = ({ isOpen, onClose, title, items, selectedItems, onApply }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-end" onClick={onClose}>
      {/* Modal Content - slides in from the right, and is now the primary scroll container */}
      <div 
        className="bg-white w-full max-w-md h-full shadow-xl overflow-y-auto transform transition-transform duration-300 ease-in-out" 
      ...
      >
        ...
        {/* Footer - now part of the main scroll flow */}
